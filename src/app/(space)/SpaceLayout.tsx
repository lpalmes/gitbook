 ...
 */
export async function SpaceRootLayout(props: { children: React.ReactNode; pathname: string[] }) {
    const { children } = props;

    const rawPathname = `https://${getPathnameParam(props.pathname)}`;

    const pointer = getContentPointer();
    // const pointer = await getContentPointerByPathname(rawPathname);
